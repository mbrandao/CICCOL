<?php /* Smarty version 2.6.26, created on 2010-06-22 22:55:19
         compiled from admmod_email_historico.tpl */ ?>
<script type="text/javascript">

// ------------------------------------Grid Histórico de Emails---------------------------

jQuery("#list_admmod_email_historico").jqGrid({
    url:'libs/lib_admmod_email_historico.php',
    width: 540,
    height:190,
    datatype: "xml",
    ...
    colModel:[
        ...
        {name:'destinatario',index:'destinatario', width:250,sortable:false,align:"center"},
...
<p class="heading">Histórico de Emails Enviados</p>
 ...
 <!--Exibe a Grid-->
<div id="form">
    <table id="list_admmod_email_historico" class="scroll" cellpadding="0" cellspacing="0"> </table>
