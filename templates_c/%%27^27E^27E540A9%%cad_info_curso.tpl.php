...
<div id="cad_info">
    <form class="dialog-form" id="form_cad_info_curso" >
		...
		<legend class="ui-widget ui-widget-header ui-corner-all">Informações do Curso</legend>
                    ...
                    <TEXTAREA type="text" name="cad_objetivo" id="cad_objetivo" class="text ui-widget-content ui-corner-all" COLS="40" ROWS="8"><?php echo $this->_tpl_vars['objet']; ?>
</TEXTAREA><br/><br/>

                    <label>Área de Atuação</label>
                    <TEXTAREA type="text" name="cad_atuacao" id="cad_atuacao" class="text ui-widget-content ui-corner-all" COLS="40" ROWS="8"><?php echo $this->_tpl_vars['atuacao']; ?>
</TEXTAREA><br/><br/>

                    <input type="text" size="10" name="cad_info_dt_criacao" id="cad_info_dt_criacao" value="<?php echo $this->_tpl_vars['dtCriacao']; ?>
