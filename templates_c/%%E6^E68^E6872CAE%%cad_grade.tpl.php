<?php /* Smarty version 2.6.26, created on 2010-06-22 22:39:49
...
jQuery("#list_cad_grade").jqGrid({
    ...
    width: 530,
    datatype: "xml",
    colNames:['Descricao', 'Data de Implantação'],
    colModel:[
        {name:'cad_grade_descricao',index:'cad_grade_descricao', width:75,sortable:false,align:"left"},
        {name:'cad_grade_dt_implantacao',index:'cad_grade_dt_implantacao', width:75,sortable:false,align:"left"}
    ],
    rowNum:10,
    rowList:[10,20,30],
...
<div id="cad_adm" style="display:none;">
    <form class="dialog-form" id="form_cad_grade" >
