    ...
    case "celular":
        switch ($request_action) {
            ...
            case "inserir_celular":
               ...
               if($row1 == ""){
                    //Insere no bano
                    $SQL1 = pg_query("INSERT INTO telefone (ddd, telefone, operadora, id_user) VALUES ('$request_ddd', '$request_numero', '$request_operadora', '3')") or die("Não foi possível inserir telefone".pg_last_error());
            ...
            case "grid_buscar_celular":
                ...
                $SQL = "SELECT ddd, telefone, operadora, id FROM telefone WHERE id_user = '3'";
