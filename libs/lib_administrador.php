        ...
        switch ($request_action) {
            ...
            case "update_administrador":
              ...
              if($result == ""){
                   ...
                   $SQL2 = pg_query("UPDATE autenticacao SET identificador = '$request_cpf' WHERE (id_user = $request_id)") or die("Nao pode atualizar autenticacao".pg_last_error());
            ...
            case "grid_buscar_administrador":
