...
switch ($request_reference) {
    case "adminmoderador":
        switch ($request_action) {
            ...
            case "update_dados_adminmoderador":
            ...
            case "grid_buscar_dados_adminmoderador":

                $idUsuario = $_SESSION['idUsuario'];
               
                $SQL = "SELECT A.matricula, U.nome, U.cpf, U.email, U.sobrenome, FuncFormataData(U.dt_nasc) as data FROM usuario U JOIN adminmoderador A ON U.id_user= '$idUsuario' AND A.id_user = U.id_user";
